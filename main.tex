...
\usepackage{hyperref}
\usepackage{graphicx}
a4bb6bae-2dad-11e5-80bd-3c15c2c7a012\usepackage{amsmath}
\usepackage{pgfplots}
\usepackage{hyperref}
a4bb6bae-2dad-11e5-80bd-3c15c2c7a012\usepackage{breakurl}
a4bb6bae-2dad-11e5-80bd-3c15c2c7a012\usepackage{indentfirst}
\usepackage{authblk}
...
a4bb6bae-2dad-11e5-80bd-3c15c2c7a012\addbibresource{ZTree.bib}
...
a4bb6bae-2dad-11e5-80bd-3c15c2c7a012\begin{abstract}
...
\end{abstract}
a4bb6bae-2dad-11e5-80bd-3c15c2c7a012
\section{Notation}
...
a4bb6bae-2dad-11e5-80bd-3c15c2c7a012\par Simply put, DHTs were created to provide hash table-like functionality on an Internet-scale level~\cite{Ratnasamy:2001wn}. They expose basic PUT and GET requests (operating on (key,value) pairs) to clients, allowing them to store and retrieve information from the DHT. The difference between a hash table and a DHT is the scope of the mechanism: DHTs are able to operate in an entirely decentralized setting, in which the responsibility for the mapping of keys to values is distributed pseudo-uniformly among all participants in a P2P network. Notable networks that utilize DHTs include the Coral Content Distribution Network~\cite{Freedman:2004vb}, the Storm Botnet~\cite{Holz:2008uk}, and the BitTorrent file sharing protocol~\cite{Cohen:y1_8mBnw}.
...
\printbibliography
a4bb6bae-2dad-11e5-80bd-3c15c2c7a012\end{document}

...
\usepackage{hyperref}
\usepackage{graphicx}
a4e85a88-2dad-11e5-afec-3c15c2c7a012\usepackage{amsmath}
\usepackage{pgfplots}
\usepackage{hyperref}
a4e85a88-2dad-11e5-afec-3c15c2c7a012\usepackage{breakurl}
\usepackage{indentfirst}
\usepackage{authblk}
\usepackage{todonotes}
\usepackage[doublespacing]{setspace}
a4e85a88-2dad-11e5-afec-3c15c2c7a012\usepackage[margin=1in]{geometry}
...
\end{abstract}
a4e85a88-2dad-11e5-afec-3c15c2c7a012
\section{Notation}

Tuples (concatenation): $[a,b,c,...]$

a4e85a88-2dad-11e5-afec-3c15c2c7a012Application of a function $f$ to an input $x$: $y=f(x)$
...
a4e85a88-2dad-11e5-afec-3c15c2c7a012\par To illustrate this concept of locality, take the two pairs of numbers $(1,2)$ and $(8,10)$. We can intuitively tell that the $(1,2)$ is a 'close' pair; mathematically, we could say that this distance is the difference of the two numbers, $1$. The second pair is both 'far' from $(1,2)$ individually farther apart. , we can say that locality is preserved for any given set of objects (serializable to a numeric representation in some fashion) $A,B,$ and $C$ in a function $f$ such that
\begin{equation}
|A-B| < |B-C| \Rightarrow |f(A)-f(B)| < |f(B) - f(C)|,
a4e85a88-2dad-11e5-afec-3c15c2c7a012\end{equation}
